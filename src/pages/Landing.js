  ...
  return (
    <div id="container" className="landing">
      ...
      <div className="landing-header">
        <div className="landing-logo">  <img src="/images/logo.png" alt="logo" /></div>
        <nav>
          <div>
            <Link to="#">Home</Link>
      ...
      <div className="landing-content">
        <div className="left">
          <div>
            ...
            <p>Explore your music activities and generate new and exciting playlists without having to open your Muzira app at all</p>
            <button>Continue with Muzira</button>
          </div>
        </div>
        <div className="right">
          <img src='/images/kendrick.png' alt="Kendrick lamar" className="img-1" />
